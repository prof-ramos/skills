---
id: "e92c5e75-a0ae-4789-a05e-3d1d9e55403b"
name: "vazamento-dados-lgpd-dano-moral-stj"
title: "Vazamento de Dados Pessoais e Dano Moral (LGPD + STJ)"
category: "materia"
materia: "digital-dados"
documentType: null
version: 1
sourcePath: "lib/skills/official/materia/digital-dados/vazamento-dados-lgpd-dano-moral-stj.md"
triggers:
  - "vazamento de dados"
  - "leak de dados"
  - "LGPD dano moral"
...
**STJ pacífico**: força maior + caso fortuito **NÃO afastam** por si sós; depende de o controlador comprovar a robustez das medidas de segurança (art. 46), sob a lógica do fortuito interno.
...
O arbitramento é caso a caso, pelo método bifásico do STJ (REsp 1.152.541): grupo de precedentes sobre dano análogo + circunstâncias do caso (natureza do dado, extensão do vazamento, uso indevido comprovado, capacidade econômica). Vazamento seguido de estelionato com prejuízo financeiro comprovado permite cumular dano material (CC 186 + 927).

## Tutela coletiva

- **ACP** (Lei 7.347/85), MP, defensoria, associações com pertinência;
- **Dano moral coletivo**: admitido pela jurisprudência do STJ em lesões coletivas relevantes (sem súmula específica);
