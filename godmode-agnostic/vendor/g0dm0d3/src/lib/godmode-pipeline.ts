/**
 * Extracted pure GODMODE pipeline pieces from G0DM0D3 api/lib/ultraplinian.ts
 * and wired to the single-source godmode-prompt + libertas modules.
 * Upstream: https://github.com/elder-plinius/G0DM0D3 (AGPL-3.0)
 */

export { GODMODE_SYSTEM_PROMPT } from './godmode-prompt'
export {
  HALL_OF_FAME,
  injectQuery,
