// Dashboard — KPI strip + atividades-em-curso (2-up) + sidebar with
// pendências, comunicação placeholder and countries progress.
    ...
    <main className="page">
      ...
      <section className="section-grid">
        ...
        <aside style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
          ...
          <div className="card">
            <div className="h-card"><span className="ico"><Icon name="mail" size={20} color="#76aeea" /></span><h2 style={{ fontSize: 18 }}>Comunicação</h2></div>
            <div style={{ background: 'var(--surface-container-low)', border: '1px dashed var(--border-subtle)', borderRadius: 10, padding: '20px 16px', textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 10 }}>
              <Icon name="clock" size={20} color="var(--fg-4)" />
              <div>
                <div style={{ fontSize: 13, fontWeight: 600, color: 'var(--on-surface)' }}>Em desenvolvimento</div>
                <div style={{ fontSize: 12, color: 'var(--fg-3)', marginTop: 4 }}>Métricas de e-mail e SLA em breve.</div>
              </div>
            </div>
          </div>
